      ...
      <section className="py-20 bg-gradient-to-b from-black to-purple-950/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            variants={fadeIn}
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">How We Use Our Funds</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We're committed to transparency in how platform revenue is allocated to create sustainable value.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2">Development & Founder</h3>
              <p className="text-gray-400">Funding the team building AI tools, beat generation systems, and supporting founder initiatives.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400">Strategic purchasing of tokens from the market to support value and reduce circulating supply.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400">Permanently removing tokens from circulation to reduce supply and increase token scarcity.</p>
            </motion.div>
          </div>
        </div>
      </section>
